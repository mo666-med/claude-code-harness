...
>
> **次にやること：**
> 1. `docs/proposal.md` をクライアントに送付して、承認をもらう
...
1. **docs/proposal.md** - クライアント向け提案書（見積もり、スケジュール含む）
2. **docs/technical-spec.md** - 技術仕様書（アーキテクチャ、技術選定理由）
3. **docs/priority_matrix.md** - 機能優先度マトリクス
4. **Plans.md** - 開発者用実装計画
